...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xcube-cci-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10891&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xcube-cci-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xcube-cci` can be installed with:

```
conda install xcube-cci
```

It is possible to list all of the versions of `xcube-cci` available on your platform with:
